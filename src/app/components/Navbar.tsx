...
//NextJS me by default component hote he wo server components hi hote hai.
//But aapko agar hooks ko use karna ho to aapko client component banana padega using
